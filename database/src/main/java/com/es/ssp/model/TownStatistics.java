 ...
 * @since 1.0
 */
public class TownStatistics  implements Serializable{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "TownStatistics";
	public static final String ALIAS_RECORD_ID = "recordId";
	public static final String ALIAS_TOWN = "town";
	public static final String ALIAS_TOTAL_VOLUNTEER = "totalVolunteer";
	...
	private String town;
    /**
     * totalVolunteer       db_column: totalVolunteer 
     */	
	...
	public void setTotalVolunteer(Integer value) {
		this.totalVolunteer = value;
	}
	
	public Integer getTotalVolunteer() {
		return this.totalVolunteer;
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof TownStatistics == false) return false;
		if(this == obj) return true;
		TownStatistics other = (TownStatistics)obj;
