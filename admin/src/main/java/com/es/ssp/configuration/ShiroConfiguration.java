...
//        shiroFilterFactoryBean.setFilters(filters);
        ...
        filterChainDefinitionManager.put("/loginuser/login",  "anon");
        filterChainDefinitionManager.put("/loginuser/toLogin",  "anon");
        filterChainDefinitionManager.put("/getKaptcha",  "anon");
        filterChainDefinitionManager.put("/**",  "authc");//其他资源全部拦截
        shiroFilterFactoryBean.setFilterChainDefinitionMap(filterChainDefinitionManager);

        shiroFilterFactoryBean.setLoginUrl("/loginuser/login");
